...
"}")
        ...
        self.lineEdit_COZE_API_KEY = QtWidgets.QLineEdit(parent=self.main_frame)
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.lineEdit_COZE_API_KEY.setFont(font)
        self.lineEdit_COZE_API_KEY.setStyleSheet("QLineEdit {\n"
"    border: 1px solid rgb(30, 131, 255);\n"
"    border-radius: 6px;\n"
"    padding: 5px;\n"
"    background-color: white;\n"
